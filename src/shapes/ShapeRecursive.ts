...
import { IParentBufferIndex, IShapeRecursiveProps, IShapeRecursiveSettings } from '../types/shape-base'
	...
	protected addIndex(
		...
		if (this.shape) {
			...
			for (
				...
				const recursionBufferIndex: IParentBufferIndex = { ...bufferIndex, recursion: currentRecursionRepetition }
